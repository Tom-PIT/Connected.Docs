...
Open this screen to view, add and edit organization units used by Production.
...
- **Tags** — select zero or more tags.
- **Parent** — optionally select a parent unit to build a hierarchy.
- **Enabled** — check to enable the unit.

![Organization units – New](../Assets/OrganizationUnitsNew.png "Organization units – New")
...
If confirmed, the record is permanently removed from the Production Organization units list; referenced data in other domains is not affected.
