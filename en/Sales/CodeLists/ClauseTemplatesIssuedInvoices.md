...
![Clause templates list](../Assets/ClauseTemplatesIssuedInvoices.png "Clause templates list")
...
![Add template](../Assets/ClauseTemplatesIssuedInvoicesNew.png "Add template")

After adding the template, you must click **Clauses** to open the clause editor.

![Clauses button](../Assets/ClauseTemplatesDeliveryNotesClausesButton.png "Clauses button")
...
![Add clause](../Assets/ClauseTemplatesIssuedInvoicesClausesNew.png "Add clause")

### Clause list

All clauses assigned to the template are shown in order:

![Clause list](../Assets/ClauseTemplatesIssuedInvoicesClausesList.png "Clause list")
