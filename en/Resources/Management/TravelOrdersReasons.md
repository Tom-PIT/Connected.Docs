...
Travel order reasons define the possible purposes of a business trip.  
They are used when creating **travel orders**, allowing users to select a predefined reason instead of entering free text.
