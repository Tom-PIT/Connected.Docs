...
The **Process** section displays all planned operations, inputs, resources, outputs, and [quality checks](ProductionOrderQuality.md) for the chosen version and its operations.
