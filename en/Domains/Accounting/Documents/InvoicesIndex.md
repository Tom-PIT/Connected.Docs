...
> [!NOTE]
Some document types are fully documented in the [**Sales**](../../Sales/Domain/SalesDomain.md) domain to avoid duplication. Accounting-specific behavior (posting, status, payments) is documented here only when it differs.
