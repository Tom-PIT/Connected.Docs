...
1. From the committed offer, use **Linked documents → [+ Sales order](../Domains/Sales/Documents/SalesOrders.md)**
...
1. From the sales order or the delivery note, open **Linked documents → [+ Issued invoice](../Domains/Sales/Documents/IssuedInvoices.md)**
