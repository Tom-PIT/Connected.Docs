...
1. Go back to the previously committed offer, and use **Linked documents → [+ Sales order](../Domains/Sales/Documents/SalesOrders.md)**
...
1. From the delivery note or the sales order, open **Linked documents → [+ Issued invoice](../Domains/Sales/Documents/IssuedInvoices.md)**
2. Apply the previously recorded prepayment via **Linked documents → [Prepayment](../Domains/Sales/Documents/Prepayments.md)** to reduce the due amount
