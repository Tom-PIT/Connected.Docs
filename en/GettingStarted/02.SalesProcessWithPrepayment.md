...
For production companies, a quick way to create a production order is from the published sales order: use **Linked documents → [**+ Production order**](../Production/Documents/ProductionOrders.md)**. This creates a Production order draft that can be committed later in the **[Production domain](../Production/Domain/ProductionDomain.md)**.
