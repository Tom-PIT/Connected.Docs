...
| Field | Description |
|-------|-------------|
| **Entity** | Document type to which the predefined text applies (mandatory): <br>• [**Delivery note**](../../Domains/Sales/Documents/DeliveryNotes.md) <br>• [**Issued invoice**](../../Domains/Sales/Documents/IssuedInvoices.md) <br>• [**Offer**](../../Domains/Sales/Documents/Offers.md) <br>• [**Supply order**](../../Supply/Documents/SupplyOrders.md) |
