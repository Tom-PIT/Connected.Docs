...
To access this page, go to **Sales / Management / Predefined texts** in the [navigation](../../Common/UI/Navigation.md).

## Schema

| Field | Description |
|-------|-------------|
| **Entity** | Document type to which the predefined text applies (mandatory): <br>• **Delivery note** <br>• **Issued invoice** <br>• **Offer** <br>• **Supply order** |
