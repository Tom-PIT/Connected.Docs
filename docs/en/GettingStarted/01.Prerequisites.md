...
These shared code lists are required by **[Sales](../Domains/Sales/SalesDomain.md)**, **[Supply](../Domains/Supply/SupplyDomain.md)**, **[Logistics](../Domains/Logistics/LogisticsDomain.md)**, **[Production](../Domains/Production/ProductionDomain.md)**, and **[System](../Domains/System/Settings/Configuration.md)**:
...
> [!IMPORTANT]
>
> Common code lists must be created before selecting them in System configuration or domain documents. See **[Common domain](../Common/Common.md)** for details.
