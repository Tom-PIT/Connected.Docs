...
<!-- app_label: Processes -->
<!-- app_navigation_hint: Open a process, select a version, click Operations, then open Non human resources for the relevant operation. -->
<!-- canonical_source_url: https://tom-pit.github.io/Connected.Docs/en/Domains/Production/Management/NonHumanResources/ -->
...
| Field | Description |
|-------|-------------|
| **Type** | Defines what kind of non-human resource is used: <br>• [**Resource**](../../Resources/Management/Resources.md)<br>• **Resource category** |
| [**Resource**](../../Resources/Management/Resources.md) | The specific resource or resource category selected based on the chosen **Type**. |
