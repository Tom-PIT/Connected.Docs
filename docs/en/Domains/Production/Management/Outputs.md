...
<!-- canonical_source_url: https://tom-pit.github.io/Connected.Docs/en/Domains/Production/Management/Outputs/ -->
...
| Field | Description |
|-------|-------------|
| **Entity** | Select whether the output refers to a [**Material**](../../Assets/Materials/README.md) or a **Material tag**. |
