...
<!-- canonical_source_url: https://tom-pit.github.io/Connected.Docs/en/Domains/Production/Management/Inputs/ -->
...
| Field | Description |
|-------|-------------|
| **Entity** | Select whether the input refers to a [**Material**](../../Assets/Materials/README.md) or a **Material tag**. |
