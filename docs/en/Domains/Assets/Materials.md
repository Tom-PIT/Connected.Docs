...
<!-- app_label: Materials -->
<!-- canonical_source_url: https://github.com/Tom-PIT/Connected.Docs/blob/main/en/Domains/Assets/Materials.md -->
...
- **[Products](Materials/Products.md)** – Finished goods produced internally or purchased as ready-to-use items. Products participate in stock and logistics flows.
- **[Semi products](Materials/SemiProducts.md)** – Items that represent partially completed goods used as intermediate components in production.
- **[Raw materials](Materials/RawMaterials.md)** – Basic input materials used at the earliest stages of production, such as wood, metal sheets, or other fundamental components.
- **[Repro materials](Materials/ReproMaterials.md)** – Returnable or auxiliary components used to support production or internal activities.
...
- **[Packaging](Materials/Packaging.md)** – Defines how a material is packaged, including quantity, weight, dimensions, and optional alternative measure units.
- **[Import materials](Materials/ImportMaterials.md)** – Allows bulk importing of materials using a spreadsheet, useful when creating or updating multiple records at once.
