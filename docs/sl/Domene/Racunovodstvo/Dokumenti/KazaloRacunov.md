...
> [!NOTE]
>Nekatere vrste dokumentov so v celoti dokumentirane v domeni [**Prodaja**](../../Prodaja/README.md), da se izognemo podvajanju. Vedenje, specifično za računovodstvo (knjiženje, status, plačila), je dokumentirano tukaj le, če se razlikuje.

## Dokumenti

- [**Prejeti računi**](PrejetiRacuni.md)
