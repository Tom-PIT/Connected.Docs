...
To access the **My Tasks** screen, navigate to **Projects / Views / My tasks** in the [navigation](../../../Zajednicko/UI/Navigacija.md).

## My tasks list

The list displays tasks that are assigned to you and match the selected filters.

![My tasks list](../Images/MyTasksList.png "My tasks list")
