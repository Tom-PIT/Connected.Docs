...
| Polje | Opis |
|-------|------|
| **Način numeriranja dokumenta** | • **Povećanje svake godine:** numeriranje započinje ispočetka svake godine. <br> • **Povećanje:** koristi jedinstveni slijed koji se ne resetira. |
