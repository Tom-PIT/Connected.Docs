...
To access this page, go to **Production / Management / Protocol operation instance templates** in the [navigation](../../../Zajednicko/UI/Navigacija.md). Templates are shared and can be used when building operations in process versions.
