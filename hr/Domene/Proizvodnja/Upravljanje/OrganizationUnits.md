...
To access Organization units, navigate to the **Production** or **Maintenance** domains, then go to **Management / Organization units** in the [navigation](../../../Zajednicko/UI/Navigacija.md).
