...
<!-- canonical_source_url: https://github.com/Tom-PIT/Connected.Docs/blob/main/en/Domains/Assets/README.md -->
...
To access the Assets domain, navigate to **Assets** in the [navigation](../../Zajednicko/UI/Navigacija.md).
