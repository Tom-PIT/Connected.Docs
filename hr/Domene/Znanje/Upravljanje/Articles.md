...
To manage articles, go to **Knowledge / Management / Directories** in the [navigation](../../../Zajednicko/UI/Navigacija.md) and click **Articles** under the desired directory (see [**Directories**](Directories.md)).
