...
- **Upravljanje** – konfiguracija in vzdrževanje definicij kontrolnih listov, ki se uporabljajo v proizvodnji in vzdrževanju.
  - [**Kontrolne liste**](../../Proizvodnja/Sifranti/KontrolniSeznami.md) — upravljanje predlog kontrolnih listov (struktura, koraki, kriteriji in mejne vrednosti). Gre za isti šifrant, ki je na voljo v domeni [Proizvodnja](../../Proizvodnja/Domena/DomenaProizvodnja.md) in se tam tudi centralno vzdržuje.

> [!NOTE]
> Urejanje predlog kontrolnih listov se izvaja v proizvodnem šifrantu: [Kontrolni listi](../../Proizvodnja/Sifranti/KontrolniSeznami.md). Domena **Kvaliteta** se osredotoča na spremljanje aktivnih in zaključenih izvajanj.
