...
| [**Država**](../../Skupno/Šifranti/Države.md) | Država, v kateri je banka registrirana (obvezno). |
...
Seznam prikazuje vse evidentirane banke, vključno z njihovim **imenom**, **kodo BIC** in [**državo**](../../Skupno/Šifranti/Države.md).
