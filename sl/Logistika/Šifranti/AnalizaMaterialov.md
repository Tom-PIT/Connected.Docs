...
| Polje | Opis |
|-------|------|
| **Tip** | Vrsta materiala (izdelek, polizdelek, surovina ali repro material) (obvezno). |
| **[Materiali](../../Sredstva/Domena/Materiali.md)** | Konkreten material, za katerega velja analiza (obvezno). |
