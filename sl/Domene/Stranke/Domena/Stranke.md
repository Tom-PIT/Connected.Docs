...
Medtem ko se domena **[Prodaja](../../Prodaja/Domena/Prodaja.md)** osredotoča na komercialne transakcije, se domena Stranke osredotoča na **poprodajno komunikacijo, reševanje težav in podporo strankam**.

Za dostop do domene pojdite na **Stranke** v glavnem zemljevidu aplikacije.

![Domena Stranke – zemljevid](../Images/CustomerSupportDomainSitemapSL.png "Domena Stranke")
...
![Pregled domene Stranke](../Images/CustomerSupportDomainOverviewSL.png "Pregled domene Stranke")
...
![Obiskovalci – Stranke](../Images/CustomerSupportDomainVisitorsSL.png "Obiskovalci – Stranke")
...
![Pogledi – Stranke](../Images/CustomerSupportDomainCompanyCardsSL.png "Pogledi – Stranke")
...
![Upravljanje – Stranke](../Images/CustomerSupportDomainManagementSL.png "Upravljanje – Stranke")
...
| Področje | Povezava |
|--------|----------|
| **Prodaja** | Skupni podatki o strankah in podjetjih |
| **Projekti** | Prijave se lahko nanašajo na projekte strank |
| **Vzdrževanje** | Prijave so lahko povezane z vzdrževalnimi nalogi |
| **Viri** | Razporejanje in obremenitev podpornih ekip |
| **Znanje** | Dokumentacija in baza znanja za podporo reševanju težav |

## Povzetek

Domena Stranke centralizira vse dejavnosti, povezane s podporo strankam.

Omogoča:

- upravljanje prijav in zahtevkov strank,  
- spremljanje napredka reševanja in ravni storitev,  
- konfiguracijo obvestil in podpornih področij,  
- strukturirano razvrščanje strank,  
- pregled nad aktivnostmi, povezanimi s strankami.  

S povezovanjem operativne podpore s prodajnimi, projektnimi in drugimi podatki domena Stranke zagotavlja dosledne in učinkovite delovne tokove podpore strankam.
