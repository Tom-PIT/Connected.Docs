...
| Domena | Povezava |
|------|----------|
| **[Prodaja](../../Prodaja/Domena/Prodaja.md)** | Izdani računi, prihodki, terjatve |
| **[Nabava](../../Nabava/Domena/Nabava.md)** | Prejeti računi, stroški, obveznosti |
| **[Logistika](../../Logistika/Domena/Logistika.md)** | Premiki in vrednotenje zaloge |
| **[Sredstva](../../Sredstva/Domena/DomenaSredstve.md)** | Osnovna sredstva in amortizacija |

## Povzetek

Domena Računovodstvo predstavlja **finančno hrbtenico sistema**.  
Operativne aktivnosti pretvarja v strukturirane računovodske podatke, omogoča zakonsko poročanje in zagotavlja močna analitična orodja za finančni nadzor.

S kombinacijo **dokumentov**, **pregledov** in **nastavitev** zagotavlja preglednost, skladnost in doslednost vseh poslovnih procesov.
