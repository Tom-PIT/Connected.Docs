...
1. Iz potrjenega predračuna izberite **Povezani dokumenti → [+ Predplačilo](../Domene/Prodaja/Dokumenti/Predplacila.md)**
2. Izpolnite:
   1. datum zapadlosti
...
1. Vrnite se na predhodno potrjeno ponudbo in izberite **Povezani dokumenti → [+ Naročilo stranke](../Domene/Prodaja/Dokumenti/NarocilaStrank.md)**
...
1. Iz dobavnice ali naročila stranke odprite **Povezani dokumenti → [+ Izdani račun](../Domene/Prodaja/Dokumenti/IzdaniRacuni.md)**
2. Uporabite predhodno zabeleženo predplačilo preko **Povezani dokumenti → [Predplačilo](../Domene/Prodaja/Dokumenti/Predplacila.md)** za zmanjšanje zneska za plačilo
