...
Ta vodič prikazuje tipičen prodajni proces brez uporabe [avansnega računa](../Domene/Prodaja/Dokumenti/AvansniRacuni.md). Za podrobnosti uporabite povezave; nastavitev ne podvajajte na tej strani.

![Prodajni proces brez avansnega računa](Images/SalesFlowWithoutPrepaymentSL.svg "Prodajni proces brez avansnega računa")
...
4. Kliknite **Objavi** za potrditev dokumenta.
...
1. Iz potrjene ponudbe izberite **Povezani dokumenti → [+ Naročilo stranke](../Domene/Prodaja/Dokumenti/NarocilaStrankUstvarjanje.md)**.
   ...
   ![Ustvarjanje naročila stranke iz ponudbe](Images/OfferSalesOrder2SL.png "Ustvarjanje naročila stranke iz ponudbe")
...
1. Iz naročila stranke odprite **Povezani dokumenti → [+ Dobavnica](../Domene/Prodaja/Dokumenti/Dobavnice.md)**.  
   Preverite **Stranka**, **Naslov dobave** in dodajte postavke za odpremo. Količine lahko prilagodite, če se dostavlja le del naročila.
