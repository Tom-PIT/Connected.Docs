...
|Polje|Opis
|---|---
|Šifra| **Šifra** skladišča. Šifra mora biti unikatna znotraj celotnega seznama.
|Naziv| **Naziv** oziroma ime skladišča.
|Opis| Kratek **Opis** skladišča.

## Upravljanje

Upravljanje s šifrantom skladišč je dostopno preko [navigacije](../../Common/UI/Sitemap.md) in sicer preko **Logistika/Upravljanje/Skladišča**.
...
S klikom na gumb **Potrdi** se ustvari novo skladišče in uporabniški vmesnik preide v privzet način, ki prikazuje seznam obstoječih skladišč. 

![Seznam](../Assets/WarehouseList.png "Seznam")

S klikom na gumb **Prekliči** pa uporabniški vmesnik preide v privzet način, brez da bi vnešene podatke shranil, torej ne ustvari novega skladišča, ampak postopek prekine brez shranjevanja.

## Urejanje

Za urejanje posameznega skladišča v seznamu skladišč kliknemo na njegov **Naziv**. Uporabniški vmesnik preide v način urejanja skladišča, ki je pravzaprav identično tistemu za vnos, le da so v tem primeru podatki že izpolnjeni. 
